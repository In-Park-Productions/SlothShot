...
static func calculate_projectile(speed:float,drag_vector:Vector2,local_mouse_position:Vector2,Gravity:float,\
		Facing:int,Air_resisitance:float,Weight:float)->Array:
	#assending
